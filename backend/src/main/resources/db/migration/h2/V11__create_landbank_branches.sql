...
CREATE INDEX IF NOT EXISTS idx_landbank_branches_office_id ON landbank_branches (office_id);
CREATE INDEX IF NOT EXISTS idx_landbank_branches_active ON landbank_branches (active);
