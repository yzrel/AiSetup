...
public class Tna2GenerationRequest {
    ...
    @NotNull
    private Map<String, Object> tna1Form = new HashMap<>();

    @NotNull
    private Tna1TablesDto tna1Tables = new Tna1TablesDto();
    ...
    public Map<String, Object> getTna1Form() { return tna1Form; }
    public void setTna1Form(Map<String, Object> tna1Form) { this.tna1Form = tna1Form; }

    public Tna1TablesDto getTna1Tables() { return tna1Tables; }
    public void setTna1Tables(Tna1TablesDto tna1Tables) { this.tna1Tables = tna1Tables; }
}
